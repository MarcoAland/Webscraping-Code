...
def get_params():
    ...
    #for i in range(1, 5):
        param = "device=desktop&navsource=&ob=23&page={}&q={}%20pria&related=true&rows=60&safe_search=false&scheme=https&shipping=&source=search&srp_component_id=02.01.00.00&srp_page_id=&srp_page_title=&st=product&start={}&topads_bucket=true&unique_id=4474d215396da4b9563b0ab4a44e7106&user_addressId=&user_cityId=176&user_districtId=2274&user_id=&user_lat=&user_long=&user_postCode=&user_warehouseId=12210375&variants=".format(i, cari, (i-1)*60)
        params.append(param)
    return params
...
if __name__ == '__main__':
    ...
    df.to_excel("Data_Sepatu.xlsx", index=False)
